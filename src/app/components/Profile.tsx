              ...
              <div className='flex justify-between items-start mt-3'>
                ...
                <div className='flex flex-col'>
                  ...
                  {data.userId === userId ? 
                    ...
                    : 
                    !checkfollow ? 
                    <button onClick={() => {handleFollow(userName,userId)}} className='border-black'>
                      フォローする
                    </button>
                    :
                    <button onClick={() => {handleCancelFollow(checkfollow)}} className='border-black'>
                      フォローを解除する
                    </button>
                  }
                </div>
